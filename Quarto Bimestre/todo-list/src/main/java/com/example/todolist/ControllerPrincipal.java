...
public class ControllerPrincipal implements Initializable {
    ...
    public void loadCategories() {
        String category1 = "Ciências Humanas";
        String category2 = "Ciências da Natureza";
        String category3 = "Matemática";
        String category4 = "Linguagens";
        String category5 = "Disciplinas técnicas";
    ...
    public void selected(javafx.scene.input.MouseEvent mouseEvent) {
        ...
        comboBoxCategories.getSelectionModel().select(clickedTask.getCategory());
    }
